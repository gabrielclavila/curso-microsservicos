...
import br.com.gabrielclavila.pedidos.api.service.PedidoService;
...
public class PedidoController {
    ...
    @Operation(summary = "Criar um novo pedido", description = "Contém as operações para criar um novo pedido",
